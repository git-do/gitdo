...
~~~sh
# getting the code
git clone git@github.com:nko4/meltmedia.git && cd ./meltmedia/

# developing
npm install
npm start

# deploying (to http://meltmedia.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@meltmedia.2013.nodeknockout.com
ssh root@meltmedia.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@meltmedia.2013.nodeknockout.com
ssh -i ./id_deploy root@meltmedia.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/meltmedia" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
